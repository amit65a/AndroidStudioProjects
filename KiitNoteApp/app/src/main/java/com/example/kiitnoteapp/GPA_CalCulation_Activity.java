...
public class GPA_CalCulation_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gpa_cal_culation);
//
        e1=findViewById(R.id.internalphysics);
        e2=findViewById(R.id.endsemphysics);
        e3=findViewById(R.id.internalmaths);
        e4=findViewById(R.id.endemmaths);
        e5=findViewById(R.id.internalsls);
        e6=findViewById(R.id.endsls);
        e7=findViewById(R.id.internalEvs);
        e8=findViewById(R.id.endEvs);
        ...
        e13=findViewById(R.id.endphylab);
        e14=findViewById(R.id.totalmarkprogramming);
        e15=findViewById(R.id.totalmarkEgraphics);


        //for grade
        g1=findViewById(R.id.gradephysics);
        g2=findViewById(R.id.grademaths);
        g3=findViewById(R.id.gradesls);
        g4=findViewById(R.id.gradeEvs);
        g5=findViewById(R.id.gradeelective1);
        g6=findViewById(R.id.gradeelective2);
        g7=findViewById(R.id.gradephylab);
        g8=findViewById(R.id.gradeprogramming);
        g9=findViewById(R.id.gradeEgraphics);
            ...
            public void onClick(View view) {
                if(t1.isEmpty()&&t2.isEmpty()&&t3.isEmpty()&&t4.isEmpty()&&t5.isEmpty()&&t6.isEmpty()&&t7.isEmpty()&&t8.isEmpty()&&t9.isEmpty()&&t10.isEmpty()&&t11.isEmpty()&&t12.isEmpty()&&t13.isEmpty()&&t14.isEmpty()&&t15.isEmpty()){
                    ...
                    if ((a1 <= 100 && a1 >= 0) && (a2 <= 100 && a2 >= 0) && (a3 <= 100 && a3 >= 0) && (a4 <= 100 && a4 >= 0) && (a5 <= 100 && a5 >= 0) && (a6 <= 100 && a6 >= 0) && (a7 <= 100 && a7 >= 0) && (a8 <= 100 && a8 >= 0) && (a9 <= 100 && a9 >= 0)) {
                        ...
                        Toast.makeText(GPA_CalCulation_Activity.this, "Please provide correct details!!", Toast.LENGTH_SHORT).show();
