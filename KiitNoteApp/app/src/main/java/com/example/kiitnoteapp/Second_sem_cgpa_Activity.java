...
public class Second_sem_cgpa_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_second_sem_cgpa);

        e1=findViewById(R.id.internalchemistry);
        e2=findViewById(R.id.endchemistry);
        e3=findViewById(R.id.internalcalculus);
        e4=findViewById(R.id.endcalculus);
        e5=findViewById(R.id.internalEnglish);
        e6=findViewById(R.id.endEnglish);
        e7=findViewById(R.id.internalBasicElect);
        e8=findViewById(R.id.endBasicElect);
        e9=findViewById(R.id.internalelective1);
        e10=findViewById(R.id.endelective1);
        e11=findViewById(R.id.internalelective2);
        e12=findViewById(R.id.endelective2);
        e13=findViewById(R.id.endChemslab);
        e14=findViewById(R.id.totalmarkEngLab);
        e15=findViewById(R.id.totalmarkWorkshop);
        e16=findViewById(R.id.totalmarkyoga);
        e17=findViewById(R.id.editTextNumberDecimal);


        //for grdae
        g1=findViewById(R.id.gradechemistry);
        g2=findViewById(R.id.gradecalculus);
        g3=findViewById(R.id.gradeEnglish);
        g4=findViewById(R.id.gradeBasicElect);
        g5=findViewById(R.id.gradeelective1);
        g6=findViewById(R.id.gradeelective2);
        g7=findViewById(R.id.gradechemslab);
        g8=findViewById(R.id.gradeEnglab);
        g9=findViewById(R.id.gradeWorkshop);
        g10=findViewById(R.id.gradeYoga);
        g11=findViewById(R.id.grdaeCommlab);
            ...
            public void onClick(View view) {
                if(t1.isEmpty()&&t2.isEmpty()&&t3.isEmpty()&&t4.isEmpty()&&t5.isEmpty()&&t6.isEmpty()&&t7.isEmpty()&&t8.isEmpty()&&t9.isEmpty()&&t10.isEmpty()&&t11.isEmpty()&&t12.isEmpty()&&t13.isEmpty()&&t14.isEmpty()&&t15.isEmpty()&&t16.isEmpty()&&t17.isEmpty()){
                    ...
                    if ((a1 <= 100 && a1 >= 0) && (a2 <= 100 && a2 >= 0) && (a3 <= 100 && a3 >= 0) && (a4 <= 100 && a4 >= 0) && (a5 <= 100 && a5 >= 0) && (a6 <= 100 && a6 >= 0) && (a7 <= 100 && a7 >= 0) && (a8 <= 100 && a8 >= 0) && (a9 <= 100 && a9 >= 0) && (a10 <= 100 && a10 >= 0) && (a11 <= 100 && a11 >= 0)) {
                        ...
                        Toast.makeText(Second_sem_cgpa_Activity.this, "Please provide correct details!!", Toast.LENGTH_SHORT).show();
