...
public class Third_Sem_Gpa_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_third_sem_gpa);

        e1=findViewById(R.id.internalPS);
        e2=findViewById(R.id.endPS);
        e3=findViewById(R.id.internalindustry);
        e4=findViewById(R.id.endindustry);
        e5=findViewById(R.id.internalDS);
        e6=findViewById(R.id.endDS);
        e7=findViewById(R.id.internalDSD);
        e8=findViewById(R.id.endDSD);
        e9=findViewById(R.id.internalafl);
        e10=findViewById(R.id.endafl);
        e11=findViewById(R.id.internalelective);
        e12=findViewById(R.id.endelective);
        e13=findViewById(R.id.Totalmarksdsalab);
        e14=findViewById(R.id.totaldsdlab);

        //for grade
        g1=findViewById(R.id.gradePs);
        g2=findViewById(R.id.gradeindustry);
        g3=findViewById(R.id.gradeDS);
        g4=findViewById(R.id.gradeDSD);
        g5=findViewById(R.id.gradeafl);
        g6=findViewById(R.id.gradeelective);
        g7=findViewById(R.id.gradeDsalab);
        g8=findViewById(R.id.gradeDsdlab);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(t1.isEmpty()&&t2.isEmpty()&&t3.isEmpty()&&t4.isEmpty()&&t5.isEmpty()&&t6.isEmpty()&&t7.isEmpty()&&t8.isEmpty()&&t9.isEmpty()&&t10.isEmpty()&&t11.isEmpty()&&t12.isEmpty()&&t13.isEmpty()&&t14.isEmpty()){
                    ...
                    if((a1<=100&&a1>=0)&&(a2<=100&&a2>=0)&&(a3<=100&&a3>=0)&&(a4<=100&&a4>=0)&&(a5<=100&&a5>=0)&&(a6<=100&&a6>=0)&&(a7<=100&&a7>=0)&&(a8<=100&&a8>=0)) {
                        float p1 = a1 * 4;
                        float p2 = a2 * 2;
                        float p3 = a3 * 4;
                        float p4 = a4 * 3;
                        ...
                        float total = (p1 + p2 + p3 + p4 + p5 + p6 + p7 + p8 ) / 10;
                        float ss = total / 22;
                    ...
                    Toast.makeText(Third_Sem_Gpa_Activity.this,"Please provide correct details!!",Toast.LENGTH_SHORT).show();
                }
