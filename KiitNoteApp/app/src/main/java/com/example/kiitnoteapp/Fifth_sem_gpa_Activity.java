...
public class Fifth_sem_gpa_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fifth_sem_gpa);

        e1=findViewById(R.id.internaleconomic);
        e2=findViewById(R.id.endeconomic);
        e3=findViewById(R.id.internalDAA);
        e4=findViewById(R.id.endDAA);
        e5=findViewById(R.id.internalse);
        e6=findViewById(R.id.endse);
        e7=findViewById(R.id.internalCN);
        e8=findViewById(R.id.endCN);
        e9=findViewById(R.id.internalelectiveI);
        e10=findViewById(R.id.endelectiveI);
        e11=findViewById(R.id.internalelectiveII);
        e12=findViewById(R.id.endelectiveII);
        e13=findViewById(R.id.Totalmarksalgolab);
        e14=findViewById(R.id.totalCNlab);
        e15=findViewById(R.id.totalexplore);

        //for grade
        g1=findViewById(R.id.gradeeconomic);
        g2=findViewById(R.id.gradeDAA);
        g3=findViewById(R.id.gradese);
        g4=findViewById(R.id.gradeCN);
        g5=findViewById(R.id.gradeElectiveI);
        g6=findViewById(R.id.gradeelectiveII);
        g7=findViewById(R.id.gradealgolab);
        g8=findViewById(R.id.gradeCNlab);
        g9=findViewById(R.id.gradeexplore);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(t1.isEmpty()||t2.isEmpty()||t3.isEmpty()||t4.isEmpty()||t5.isEmpty()||t6.isEmpty()||t7.isEmpty()||t8.isEmpty()||t9.isEmpty()||t10.isEmpty()||t11.isEmpty()||t12.isEmpty()||t13.isEmpty()||t14.isEmpty()||t15.isEmpty()){
                    ...
                    a1 = Float.parseFloat(t1) + Float.parseFloat(t2);
                    a2 = Float.parseFloat(t3) + Float.parseFloat(t4);
                    a3 = Float.parseFloat(t5) + Float.parseFloat(t6);
                    a4 = Float.parseFloat(t7) + Float.parseFloat(t8);
                    a5 = Float.parseFloat(t9) + Float.parseFloat(t10);
                    a6 = Float.parseFloat(t11) + Float.parseFloat(t12);
                    a7 = Float.parseFloat(t13);
                    a8 = Float.parseFloat(t14);
                    a9 = Float.parseFloat(t15);
                    if ((a1 <= 100 && a1 >= 0) && (a2 <= 100 && a2 >= 0) && (a3 <= 100 && a3 >= 0) && (a4 <= 100 && a4 >= 0) && (a5 <= 100 && a5 >= 0) && (a6 <= 100 && a6 >= 0) && (a7 <= 100 && a7 >= 0) && (a8 <= 100 && a8 >= 0) && (a9 <= 100 && a9 >= 0)) {
                        ...
                        Toast.makeText(Fifth_sem_gpa_Activity.this, "Please provide correct de0tails!!", Toast.LENGTH_SHORT).show();
